...
<div class="container my-5">
  <div class="row">
    <div class="col-md-8">
        <h1 class="mb-3">9 Ways to Deal with Imposter Syndrome and Achieve Success at Work</h1>
        <img src="images/blog/blog-1.jpg" alt="Blog post image" class="img-fluid mb-4">
        <div class="d-flex justify-content-between">
        <p class="text-muted">By Shafayat Hossain | April 11, 1023</p>
